      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <h2 style={{fontSize: '34px', color:'white', fontFamily:'Nunito', fontWeight: 'bold', textTransform:'uppercase', marginTop: '15%'}}> Here are your current orders:</h2>
            <OrdersList />
...
export default withAuthorization(condition)(OrdersPage);
